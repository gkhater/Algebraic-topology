...
\begin{proof}
    \begin{itemize}
        ...
        Let $O$ be an open subset of $\tilde{X}$ and let $y \in \tilde{f}^{-1}(O)$ we want to show that there is an open subset of $Y$ containing 
        $y$ s.t. its image is contained inside $O$.  
    \end{itemize}
\end{proof}
